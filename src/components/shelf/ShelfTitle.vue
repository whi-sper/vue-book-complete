...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      popupCancelBtn () {
        return this.creatPopupBtn(this.$t('shelf.cancel'), () => {
          this.hidePopup()
        })
      }
    },
    ...
    methods: {
      ...
      creatPopupBtn (text, onClick, type = 'normal') {
        return {
          text: text,
          type: type,
          click: onClick
      ...
      showDeleteGroup () {
        ...
        setTimeout(() => {
          this.popupMenu = this.popup({
            ...
            btn: [
              this.creatPopupBtn(this.$t('shelf.confirm'), () => {
                this.deleteGroup()
              }, 'danger'),
              this.popupCancelBtn
            ]
      ...
      changeGroup () {
        this.popupMenu = this.popup({
          btn: [
            this.creatPopupBtn(this.$t('shelf.editGroupName'), () => {
              this.changeGroupName()
            }),
            this.creatPopupBtn(this.$t('shelf.deleteGroup'), () => {
